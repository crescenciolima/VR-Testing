...
You are a QA analyst. Generate 1 test case focused on SECURITY (ISO/IEC 25010) for the metaverse described below.
...
- Confidentiality – protection of profile and progress data.
- Integrity – prevention of unauthorized modifications to rankings or saved data.
- Non-repudiation – generation of logs that provide evidence of user actions.
